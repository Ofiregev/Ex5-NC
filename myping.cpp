...
//calculating the rtt
suseconds_t microSeconds = (suseconds_t) stop.tv_usec - start.tv_usec;
suseconds_t miliSeconds = (suseconds_t) microSeconds / 1000 ;


printf("The RTT in microseconds is : %.0ld\n", microSeconds);
printf("The RTT in miliseconds is : %ld\n", miliSeconds);
